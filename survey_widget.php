...
class SA_Survey_Widget extends WP_Widget {

	function __construct() {

		$args = array(
			'description' => esc_html__('Widget used to embed your Sophware Analytics survey and collect responses on your WordPress site.', 'sas_domain')
		);

		parent::__construct('sa_survey_widget', 'Sophware Analytics Surveys', $args);
	}
